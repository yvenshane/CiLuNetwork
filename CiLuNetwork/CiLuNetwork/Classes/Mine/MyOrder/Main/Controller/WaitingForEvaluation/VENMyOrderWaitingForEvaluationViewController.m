//
//  VENMyOrderWaitingForEvaluationViewController.m
//  CiLuNetwork
//
...
@interface VENMyOrderWaitingForEvaluationViewController () <UITableViewDelegate, UITableViewDataSource>
...
@implementation VENMyOrderWaitingForEvaluationViewController
...
- (void)rightButtonClick:(UIButton *)button {
    ...
    vc.block = ^(NSString *str) {
        ...
        [[NSNotificationCenter defaultCenter] postNotificationName:@"GoodsReceived" object:@"WaitingForEvaluation"];
    };
    vc.order_id = model.order_id;
    vc.index = button.tag;
    vc.pushFrom = @"待评价";
